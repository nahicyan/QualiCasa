...
export default async function handler(req, res) {
    ...
    const subjectLine = `${firstName} ${lastName} ${qualificationStatus} Pre-Qualification for ${formattedPropertyPrice}`;
    ...
    const htmlContent = `
            <div style="font-family: Arial, sans-serif; line-height: 1.5;">
                <h2 style="text-align: center; color: #333;">Seller Finance Qualification</h2>
                <p>Hi,</p>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;">Home Usage</td>
                        ...
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;">Home Purchase Timing</td>
                        ...
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;">Plan To Sell Home</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">${surveyData.plan_to_sell_home}</td>
                        </tr>
                        <tr>
    ...
    try {
        ...
        const mailOptions = {
            ...
            attachments: [
                {
                    filename: `${firstName}_${lastName}_${qualificationStatus}_For_${rawPropertyPrice}_Seller_Finance.pdf`,
                    content: pdfBuffer,
